 ...
 *
 */
public class AnimatedPShape extends PShape {
  ...
  public AnimatedPShape(PApplet parent, String filename, PImage texture) {
    this(parent, parent.createReader(filename), getBasePath(parent, filename), texture);
  }

  public AnimatedPShape(PApplet parent, BufferedReader reader, PImage texture) {
    this(parent, reader, "", texture);
  }

  public AnimatedPShape(PApplet parent, BufferedReader reader, String basePath, PImage texture) {
  ...
  protected AnimatedPShape(OBJFace face, OBJMaterial mtl,
  ...
  protected void addChildren(ArrayList<OBJFace> faces,
    ...
    for (int i = 0; i < faces.size(); i++) {
      ...
      PShape child = new AnimatedPShape(face, mtl, coords, normals, texcoords);
      addChild(child);
    }
  }


  protected void parseOBJ(PApplet parent, String path,
        ...
        if (parts.length > 0) {
          if (parts[0].equals("v")) {
            ...
            if (parts[1] != null) {
              ...
              if (mreader != null) {
                this.parseMTL(parent, path, mreader, materials, mtlTable);
                mreader.close();
              }
            }
  ...
  protected void parseMTL(PApplet parent, String path,
                                 BufferedReader reader,
                                 ArrayList<OBJMaterial> materials,
