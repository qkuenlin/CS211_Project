...
public class QuadGraph {
    ...
    public static boolean intersect(PVector line1, PVector line2, int width, int height) {
    	 ...
    	 double sin_t1 = ImageProcessing.tabSin[(int) (line1.y/ImageProcessing.discretizationStepsPhi)] *ImageProcessing.discretizationStepsR/1.f;
         double sin_t2 = ImageProcessing.tabSin[(int) (line2.y/ImageProcessing.discretizationStepsPhi)] *ImageProcessing.discretizationStepsR/1.f;
         double cos_t1 =  ImageProcessing.tabCos[(int) (line1.y/ImageProcessing.discretizationStepsPhi)] *ImageProcessing.discretizationStepsR/1.f;
         double cos_t2 =  ImageProcessing.tabCos[(int) (line2.y/ImageProcessing.discretizationStepsPhi)] *ImageProcessing.discretizationStepsR/1.f;
        float r1 = line1.x;
        float r2 = line2.x;
